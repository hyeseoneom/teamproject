						...
						<table class="u-table-entity u-table-entity-1">
							...
							<tbody class="u-table-body">
								<c:forEach items="${bList}" var="board">
									<tr style="height: 15px;">
										<td class="u-border-1 u-border-grey-30 u-table-cell">${board.cate}</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell"><a
											href="content/${board.no}" style="color: black;">${board.title}</a></td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${board.memberid }</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell"><fmt:formatDate
												value="${board.regdate }" dateStyle="short" /></td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${board.readcount}</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${board.recommend}</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>

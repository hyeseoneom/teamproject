...
<meta property="og:title" content="bBsearch">
				...
				<div class="u-expanded-width u-table u-table-responsive u-table-1">
					...
					<div style="text-align: right;">
						<div id="search" style="display: inline-block;">
							<form id="searchform" action="bBsearch">
					...
					<c:if test="${count != 0 }">
						<table class="u-table-entity u-table-entity-1">
							...
							<tbody class="u-table-body">
								<c:forEach items="${bBList}" var="bestBoard">
									<tr style="height: 15px;">
										<td class="u-border-1 u-border-grey-30 u-table-cell">${bestBoard.cate}</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell"><a
											href="content/${bestBoard.no}" style="color: black;">${bestBoard.title}</a></td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${bestBoard.memberid }</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell"><fmt:formatDate
												value="${bestBoard.regdate }" dateStyle="short" /></td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${bestBoard.readcount}</td>
										<td class="u-border-1 u-border-grey-30 u-table-cell">${bestBoard.recommend}</td>
									</tr>
								</c:forEach>
							</tbody>
						</table>

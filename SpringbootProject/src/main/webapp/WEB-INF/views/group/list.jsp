					...
					<c:if test="${begin>pageNum}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/list?p=${begin-1}"
					...
					<c:if test="${end<totalPages}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/list?p=${end+1}"
	...
	<main>
		...
		<div class="container">
			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				<a href="/groupbuying/myorder">
					<button class="btn btn-outline-dark btn-sm" type="button">내공동구매/주문</button>
				</a> <a href="/groupbuying/write">

...
<body>
	...
	<section class="u-align-center u-clearfix u-section-3" id="sec-b9e6">
		<div class="u-clearfix u-sheet u-sheet-1">
			<h3 class="u-text u-text-default u-text-1">${grno }번글의 주문 - ${search} 검색</h3>
			<div class="u-expanded-width u-table u-table-responsive u-table-1">
				...
				<c:if test="${count == 0 }">
					<p style="text-align: center;">해당 검색글이 없습니다.</p>
					...
					<c:if test="${begin>pageNum}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/orders/search/${grno}?p=${begin-1}&search=${search}&searchn=${searchn}"
					...
					<c:forEach begin="${begin}" end="${end}" var="i">
						<div class="u-container-style u-list-item u-repeater-item"
							...
							<div
								...
								<a href="/groupbuying/orders/search/${grno}?p=${i}&search=${search}&searchn=${searchn}"
					...
					<c:if test="${end<totalPages}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/orders/search/${grno}?p=${end+1}&search=${search}&searchn=${searchn}"

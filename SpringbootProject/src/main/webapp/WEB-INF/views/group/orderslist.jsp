	...
	<section class="u-align-center u-clearfix u-section-3" id="sec-b9e6">
		<div class="u-clearfix u-sheet u-sheet-1">
			...
			<div class="u-expanded-width u-table u-table-responsive u-table-1">
				<c:if test="${count != 0 }">
					<table class="u-table-entity u-table-entity-1">
						...
						<tbody class="u-table-body">
							<c:forEach items="${orders}" var="gbs" varStatus="status">

								<tr style="height: 75px;">
									<td class="u-border-1 u-border-grey-30 u-table-cell">${gbs.grno}</td>
									<td class="u-border-1 u-border-grey-30 u-table-cell"><a
										href="/groupbuying/list/${gbs.grno}"
										style="color: black; text-decoration: none;">${gbs.product }</a></td>
									<td class="u-border-1 u-border-grey-30 u-table-cell">${gbs.price }
										원</td>
									<td class="u-border-1 u-border-grey-30 u-table-cell"><fmt:formatDate
											value="${gbs.orderdate }" pattern="yyyy/MM/dd" /></td>
								</tr>
				...
				<c:if test="${count == 0 }">
					<p style="text-align: center;">내주문내역이 없습니다.</p>
					...
					<c:if test="${begin>pageNum}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/orders?p=${begin-1}"
					...
					<c:if test="${end<totalPages}">
						<div class="u-container-style u-list-item u-repeater-item">
							<div
								...
								<a href="/groupbuying/orders?p=${end+1}"
	...
	<main>
		...
		<div class="container">
			...
			<div class="d-grid gap-2 d-md-flex justify-content-md-end">
				<a href="/groupbuying/myorder">
					<button class="btn btn-outline-dark btn-sm" type="button">내공동구매</button>
					...
					<tbody>
						<c:forEach items="${orders}" var="gbs" varStatus="status">
							...
							<tr>
								...
								<td><a href="/groupbuying/list/${gbs.grno}"
								style="color: black; text-decoration: none;">${gbs.product }</a></td>
								<td>\ ${gbs.price }</td>
								<td><fmt:formatDate value="${gbs.orderdate }"

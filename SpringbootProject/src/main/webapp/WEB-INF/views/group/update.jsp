...
<c:import url="/WEB-INF/views/include/top.jsp"/>
	...
	<section class="u-align-center u-clearfix u-section-1" id="sec-cc67">
		<div class="u-align-left u-clearfix u-sheet u-sheet-1">
			<form method="post" id="writeform" action="/groupbuying/update" enctype="multipart/form-data">
				<h3 style="margin-left: 18%; margin-top: 1%;">
				<input type="hidden" name="grno" value="${group.grno}">
					<b>공동구매 수정</b>
				</h3>
				<table border="1">
				<colgroup>
					...
					<tr>
						...
						<td><input name="grtitle" class="grtitle"  placeholder="제목을 적어주세요"style="width:100%;" value="${group.grtitle }"/>
					...
					<tr>
						...
						<td><input name="memberid" class="noborder"
							value="${group.memberid }" readonly></td>
					</tr>
					<tr>
						<td class="orange">구매물품<span style="color: red">*</span></td>
						<td><input name="grproducrt" class="grproducrt"  placeholder="제품의 정확한 이름을 적어주세요" style="width:100%;" value="${group.grproduct}"/></td>
					</tr>
					<tr>
						<td class="orange">구매가격<span style="color: red">*</span></td>
						<td><input name="grprice" class="grprice"  placeholder="제품 하나당 가격을 적어주세요" style="width:100%;" value="${group.grprice}"/>
					...
					<tr>
						...
						<td><input name="grphone"
							placeholder="연락처 또는 카카오톡ID를 기재해주세요." class="pp" style="width:100%;" value="${group.grphone}">
					...
					<input type="text"   id="accountnum" placeholder="계좌번호 (해당 정보는 등록한 글에선 보이지 않습니다)" name="accountnum" style="width:75%;" value="${group.accountnum }">
				...
				<script type="text/javascript" src="/js/uploadimg.js"></script>
					...
					<tr>
						...
						<td><textarea name="grcontent" cols="40" rows="10"
								placeholder="400자 이내" class="pp" style="width:100%;">${group.grcontent}</textarea></td>
					</tr>

					<tr>
						<td colspan="2" align="center"><input type="submit"
							value="수정" id="btn"> <input type="reset" value="초기화"
							id="btn"></td>
					</tr>
				</table>
<p  class="d-none" id="bank">${group.banknum}</p>
<p class="d-none" id="fmtdate"><fmt:formatDate value="${group.grdate}" pattern="yyyy-MM-dd" /></p>
			</form>
	...
	<main>
		...
		<div class="p-4 p-md-5 mb-4 text-white  bg-dark">
			<div class="col-md-6 px-0">
				<h1 class="display-4 fst-italic">GroupBuying</h1>
			</div>
		</div>
		...
		<div class="container">
			...
			<hr>
			<form action="/groupbuying/update" method="post" enctype="multipart/form-data" id="updateform">
				<input type="hidden" name="grno" value="${group.grno}">
				<div class="row">
					<div class="col-sm-9">
						<div class="mb-3">
							<label for="grtitle" class="form-label">제목</label> <input
								...
								placeholder="제목" value="${group.grtitle }">
						</div>
					...
					<div class="col-sm-3">
						<div class="mb-3">
							<label for="memberid" class="form-label">아이디</label> <input
								...
								placeholder="아이디" value="${group.memberid }" readonly>
						</div>
					</div>
				</div>
				<hr>
				...
				<div class="mb-3">
					<label for="grphone" class="form-label">연락처</label> <input
						...
						placeholder="ex)000-0000-0000 또는 카카오톡 아이디" value="${group.grphone}">
				</div>
				...
				<div class="mb-3">
					<label for="grdate" class="form-label">공동구매 기한</label> <input
						...
						<p class="d-none" id="fmtdate"><fmt:formatDate
								value="${group.grdate}" pattern="yyyy-MM-dd" /></p>
				</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<label for="grproduct" class="form-label">제품</label> <input
							type="text" class="form-control" id="grproduct" name="grproduct" value="${group.grproduct}">
					</div>
					
					<div class="col-sm-6">
						<label for="grprice" class="form-label">가격</label> <input
							class="form-control" id="grprice" name="grprice" value="${group.grprice}">
					</div>
				...
				<div class="input-group mb-3">
					...
					<input type="text" class="form-control" style="width:800px" id="accountnum" placeholder="계좌번호 (해당 정보는 등록한 글에선 보이지 않습니다)" name="accountnum" value="${group.accountnum }">
				</div>
				<p class="text-danger" id="account_chk"></p>
				<hr>
				<div class="mb-3">
					...
					<textarea class="form-control" id="grcontent" name="grcontent"
						rows="15" placeholder="상세내용을 적어주세요">${group.grcontent}</textarea>
				</div>

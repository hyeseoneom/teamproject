...
<title>${fsarea}지역 모집글 검색 목록</title>
...
<link rel="stylesheet" href="/css/fsanother.css" media="screen">
    ...
    <meta property="og:title" content="fsanother">
...
<main>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#slide" data-bs-slide="next">
    ...
    <section class="u-clearfix u-section-2" id="sec-4189">
      ...
      <c:if test="${count != 0 }">
      <c:forEach items="${fsareaList}" var="board">
...
<div style="text-align:center;">
                <div id="search" style="display:inline-block;">
                    <form id="searchform" action="/fsboard/fsareaSearch/${fsarea}">
